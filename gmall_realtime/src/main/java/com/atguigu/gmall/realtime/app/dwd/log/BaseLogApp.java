...
public class BaseLogApp {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<JSONObject> isNewStream = keyedStream.map(new RichMapFunction<JSONObject, JSONObject>() {
            ...
            public JSONObject map(JSONObject value) throws Exception {
                ...
                if ("1".equals(isNew)) {
                    ...
                    // 标记为0
                    if (firstVisitDt == null) {
                        firstVisitDtState.update(DateFormatUtil.toDate(value.getLong("ts") - 1000 * 60 * 60 * 24));
                    }
                }
                return value;
            }
        ...
        SingleOutputStreamOperator<String> page = isNewStream.process(new ProcessFunction<JSONObject, String>() {
            @Override
        ...
        DataStream<String> startStream = page.getSideOutput(startOutputTag);
        DataStream<String> errStream = page.getSideOutput(errOutputTag);
        DataStream<String> displayStream = page.getSideOutput(displayOutputTag);
        DataStream<String> actionStream = page.getSideOutput(actionOutputTag);
        ...
        page.addSink(KafkaUtil.getKafkaProducer(page_topic));
